export const FACILITY_ICONS = {
  freeWifi: {
    id: 'freeWifi',
    name: '免费WiFi',
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 21l-1.5-1.5c-5.12-5.12-8.5-8.56-8.5-12.5 0-3.08 2.42-5.5 5.5-5.5 1.74 0 3.41.81 4.5 2.09C13.09 2.31 14.76 1.5 16.5 1.5 19.58 1.5 22 3.92 22 7c0 3.94-3.38 7.38-8.5 12.5L12 21z"/></svg>`
  },
  freeParking: {
    id: 'freeParking',
    name: '免费停车',
  ...
  breakfast: {
    id: 'breakfast',
    name: '含早餐',
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 3H6c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-1 11h-4v4h-2v-4H7v-2h4V8h2v4h4v2z"/></svg>`
  },
  gym: {
    id: 'gym',
    name: '健身房',
  ...
  laundry: {
    id: 'laundry',
    name: '洗衣服务',
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M9.17 16.83c1.56 1.56 4.1 1.56 5.66 0 1.56-1.56 1.56-4.1 0-5.66l-5.66 5.66zM18 2.01L6 2c-1.1 0-2 .89-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.11-.9-1.99-2-1.99zM10 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zM7 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm5 16c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z"/></svg>`
  },
  spa: {
    id: 'spa',
    name: 'SPA',
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M8.55 12c.17-.47.28-.97.28-1.5 0-2.21-1.79-4-4-4S.83 8.29.83 10.5c0 .53.11 1.03.28 1.5H8.55zm7.45 0h7.44c.17-.47.28-.97.28-1.5 0-2.21-1.79-4-4-4s-4 1.79-4 4c0 .53.11 1.03.28 1.5zM15.5 12c-.28 0-.5-.22-.5-.5s.22-.5.5-.5.5.22.5.5-.22.5-.5.5zm-7 0c-.28 0-.5-.22-.5-.5s.22-.5.5-.5.5.22.5.5-.22.5-.5.5zm3.5 8c-4.97 0-9-2.24-9-5v-1c0 2.76 4.03 5 9 5s9-2.24 9-5v1c0 2.76-4.03 5-9 5z"/></svg>`
  },
  frontDesk24h: {
    id: 'frontDesk24h',
    name: '24小时前台',
  ...
  luggage: {
    id: 'luggage',
    name: '行李寄存',
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M17 6h-2V3H9v3H7c-1.1 0-2 .9-2 2v11c0 1.1.9 2 2 2 0 .55.45 1 1 1s1-.45 1-1h6c0 .55.45 1 1 1s1-.45 1-1c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zM9.5 18H8V9h1.5v9zm3.25 0h-1.5V9h1.5v9zM15.5 18H14V9h1.5v9zM9 3h6v2H9z"/></svg>`
  },
  chessRoom: {
    id: 'chessRoom',
    name: '棋牌室',
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 14l-5-5 1.41-1.41L12 14.17l4.59-4.58L18 11l-6 6z"/></svg>`
  },
  teaRoom: {
    id: 'teaRoom',
    name: '茶室',
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h4v3c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-3h4c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 12H4V4h16v10z"/></svg>`
  },
  butler: {
    id: 'butler',
    name: '管家服务',
  ...
  freeUpgrade: {
    id: 'freeUpgrade',
    name: '免费升房',
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M16 18v2H8v-2h8zM11 7.99V16h2V7.99h3L12 4 8 7.99h3z"/></svg>`
  },
  wakeUp: {
    id: 'wakeUp',
    name: '叫醒服务',
  ...
  elevator: {
    id: 'elevator',
    name: '电梯',
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 14l-4-4h3V8h2v5h3l-4 4z"/></svg>`
  },
  nonSmoking: {
    id: 'nonSmoking',
    name: '无烟楼层',
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M17 3H7c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H7V5h10v14zm-4-4h2v2h-2v-2zm-4 0h2v2H9v-2z"/></svg>`
  },
  robotService: {
    id: 'robotService',
    name: '机器人服务',
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a2 2 0 012 2c0 .74-.4 1.39-1 1.73V7h1a7 7 0 017 7h1a1 1 0 011 1v3a1 1 0 01-1 1h-1v1a2 2 0 01-2 2H5a2 2 0 01-2-2v-1H2a1 1 0 01-1-1v-3a1 1 0 011-1h1a7 7 0 017-7h1V5.73c-.6-.34-1-.99-1-1.73a2 2 0 012-2M7.5 13A2.5 2.5 0 005 15.5 2.5 2.5 0 007.5 18a2.5 2.5 0 002.5-2.5A2.5 2.5 0 007.5 13m9 0a2.5 2.5 0 00-2.5 2.5 2.5 2.5 0 002.5 2.5 2.5 2.5 0 002.5-2.5 2.5 2.5 0 00-2.5-2.5z"/></svg>`
  },
  executiveLounge: {
    id: 'executiveLounge',
    name: '行政酒廊',
